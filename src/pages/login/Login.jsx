...
// const Login = () => {
//     const { login,  googlelogine} = UseAuth();
//     const location = useLocation();
//     const navigate = useNavigate();
...
//                 // get acses token
//                 const user = { email };
//                 axios.post('https://car-doctor-server-nine-gilt.vercel.app/jwt', user,
...
//                             <span onClick={handelgoogleLogin} className="w-5/6 px-4 py-3 font-bold text-center">Sign in with Google</span>
//                         </a>
//                         <p className="p-3 text-center">new to car doctors?<Link className="font-bold text-orange-300" to="/singup">sing up</Link></p>
//                     </div>
//                 </div>
//             </div>
//             <ToastContainer />
