...
const Fotter = () => {
  ...
  <aside>
   <p className="text-3xl text-black"><small className="text-red-700" >kingstar</small> <small className="text-orange-300">kids</small></p>
    <p className="text-black font-semibold">Box 35300<br/>
...
Bothell, WA 98011-8246</p>
  ...
  <nav>
    <h6 className="footer-title font-bold text-2xl text-black">Our Campus</h6> 
    <a className="link link-hover">Acedemic</a>
    <a className="link link-hover">Planning & Administration</a>
    <a className="link link-hover">Campus Safety</a>
    <a className="link link-hover">Human Resources</a>
  </nav> 
  <nav>
    <h6 className="footer-title font-bold text-2xl text-black">Campus Life</h6> 
    <a className="link link-hover">Accessibility</a>
    <a className="link link-hover">Food Services</a>
    <a className="link link-hover">Housing</a>
    <a className="link link-hover">Student Life</a>
  </nav> 
  <nav>
    <h6 className="footer-title font-bold text-2xl text-black">Academics</h6> 
    <a className="link link-hover">Canvas</a>
